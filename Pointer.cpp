...
// assigns the memory address of  to pointer . To access the content of the memory pointed to, prepend the variable name with a *. 
// For example, *p will return the value stored in  and any modification to it will be performed on .
